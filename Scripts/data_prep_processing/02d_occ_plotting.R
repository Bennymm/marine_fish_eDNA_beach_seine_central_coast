...
t5 <- out    #t5 from OccupancyModel.R
...
p1 <- ggplot(reps_occprob, aes(factor(pos_reps), prob)) +
  ...
  xlab("number of positive detection in 3 biological replicates (1576 ASVs)") +
  ylab("occupancy probability") +
  ggtitle("Occupancy Probability by biological replicate - RL model") + 
