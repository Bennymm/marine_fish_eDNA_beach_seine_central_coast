...
plot_turn
ggsave("no_occupancy_model/Figures_tables/spatial_turnover.png", 
       plot = plot_turn,
...
plot_nest
ggsave("no_occupancy_model/Figures_tables/spatial_nest.png", 
       plot = plot_nest,
       width = 3, height = 3, units = "in")
#Jaccards
...
plot_jac
ggsave("no_occupancy_model/Figures_tables/spatial_jac.png", 
       plot = plot_jac,
       width = 3, height = 3, units = "in")
...
ggsave("no_occupancy_model/Figures_tables/final.png", 
       plot = final,
...
mat_simple <- readRDS("no_occupancy_model/Data/2022_10_31/derived_data/dist_mat2015.rds") #distance by water
...
exp_gdm
ggsave("no_occupancy_model/Figures_tables/GDM/exp_partial.png", 
       plot = exp_gdm,
...
cover_gdm <- 
  ...
  theme(legend.position = "none") 
cover_gdm
ggsave("no_occupancy_model/Figures_tables/GDM/cover_partial.png", 
       plot = cover_gdm,
       width = 5, height = 4, units = "in")
...
dist_gdm
ggsave("no_occupancy_model/Figures_tables/GDM/dist_partial.png", 
       plot = dist_gdm,
       width = 5, height = 4, units = "in")
...
day_gdm
ggsave("no_occupancy_model/Figures_tables/GDM/day_partial.png", 
       plot = day_gdm,
       width = 5, height = 4, units = "in")
...
ggarrange(dist_gdm, day_gdm, cover_gdm, exp_gdm,  
          ...
          heights = c(1,1)) 
gdm_all
ggsave("no_occupancy_model/Figures_tables/GDM/gdm_all.png", 
       plot = gdm_all,
