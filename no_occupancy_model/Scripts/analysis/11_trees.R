...
taxab <- read_rds("no_occupancy_model/Data/2022_10_31/derived_data/BS_taxonomy_reconciled.rds")%>%
...
taxae <- read_rds("no_occupancy_model/Data/2022_10_31/derived_data/ASV_taxonomy_reconciled.rds")%>% 
...
ggsave("no_occupancy_model/Figures_tables/tree_by_method.png", 
       plot = tree_v1,
...
LCTs_in_order <- extract_tree_data(ggt_reordered) %>% 
  dplyr::filter(isTip) %>% 
  dplyr::pull(label) 
write_rds(LCTs_in_order, "no_occupancy_model/Data/2022_10_31/derived_data/LCTs_in_order.rds")
...
frequency 
ggsave("no_occupancy_model/Figures_tables/detection_frequency.png", 
       plot = frequency,
